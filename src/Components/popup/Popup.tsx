  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className='fixed flex-col bg-black/70  opacity-[0.6] inset-0  flex items-center z-[995] pt-[50px] px-[10px] justify-center .no-scrollbar '
      >
        <motion.div
        ...
        <motion.div
          ...
          exit={{ y: 50, opacity: 0 }}
          transition={{ duration: 0.4 }}
          className='flex flex-col rounded-[24px] w-full h-[100%]   md:w-[60%] no-scrollbar  border-[1px]  p-[8px]   bg-[#FFF0E8B2] border-[#FFE5D7]  mt-[20px] items-center overflow-scroll '
        >
          <div className='flex h-[89%] flex-col rounded-[16px] border-[1px]   border-[#FFFFFF] p-[16px] gap-[24px] popupcard  bg-[#ffffff99] w-full'>
            <div className=' h-[100%] pb-[100px] no-scrollbar overflow-scroll'>
              ...
              <div className='flex  flex-col  w-full mt-[20px] '>
                ...
                <button className='flex items-center my-[20px] justify-center gap-[8px] md:w-[120px] w-full h-[37px] border-[1px] border-[#EBF0F4] px-[16px] py-[8px] rounded-[8px] bg-[#FFFFFF] text-[#20262C] font-popmedium font-[500] text-[14px] leading-[100%]'>
          ...
          <div className='flex h-[48px] my-[10px] mb-[-60px]  rounded-[32px] items-center justify-between   border-[0.5px]   border-[#FFFFFF]  gap-[16px] popupcard  bg-[#FFFFFF99] w-full py-[6px] px-[12px] '>
            <div className='flex items-center justify-center w-[32px] h-[32px] bg-[#FFFFFF] rounded-[80px]  [box-shadow:inset_0_8px_16px_rgba(0,0,0,0.25)]'>
              <img src={logo} alt='' className='w-[16px] h-[16px]' />
            </div>
            <input
              type='text'
